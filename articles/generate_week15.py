#!/usr/bin/env python3
"""Generate HTML for Scodeno Switch: Panduan Lengkap (Week 15)"""
import re
from pathlib import Path

md_file = Path('/mnt/d/Dokumen/Konexindo/4-SEO-Konten/artikel/Week_15_scodeno-switch-panduan-lengkap.md')
out_dir = Path('/home/ace_a/projects/scodeno-landing/articles')
out_file = out_dir / 'Week_15_scodeno-switch-panduan-lengkap-industrial-ethernet-switch-untuk-jaringan-industri.html'
...
meta_desc = "Panduan lengkap Scodeno switch: lini produk unmanaged, managed, PoE, fitur DIP switch, desain fanless, wide temperature, dan cara memilih industrial ethernet switch yang tepat."
...
def flush_paragraph():
    ...
    if current_lines:
        ...
        if text:
            # Process inline: **bold**, *italic*, [link](url)
...
def flush_table():
    global current_lines, in_table, in_thead
    if current_lines:
        rows_html = []
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .article-nav-inner {{
      ...
      padding: 32px 0; border-top: 1px solid var(--gray-100);
    }}
    .article-nav-inner a {{
    ...
    .article-nav-inner .prev {{ text-align: left; }}
    .article-nav-inner .next {{ text-align: right; }}
    .article-nav-inner .nav-label {{
      color: var(--gray-400); font-size: 0.6875rem; display: block;
      text-transform: uppercase; letter-spacing: 0.04em; margin-bottom: 2px;
    }}
    .article-nav-inner .nav-title {{
      color: var(--text-dark); font-weight: 600; line-height: 1.3;
    }}
    .article-nav-back {{
      text-align: center; padding-bottom: 40px;
    }}
    .article-nav-back a {{
      color: var(--blue); text-decoration: none; font-weight: 600; font-size: 0.875rem;
    }}
    .footer {{
      ...
      <ul class="nav-links">
        <li class="nav-dropdown">
          ...
          <div class="nav-dropdown-menu">
            <a href="../#products">Unmanaged Switches</a>
            <a href="../#products">Managed Switches</a>
            <a href="../#products">PoE Switches</a>
            <a href="../#products">Data Center</a>
            <a href="../#products">xPON / Fiber</a>
            <a href="../#products">Smart Box &amp; IoT</a>
          </div>
        </li>
        <li class="nav-dropdown">
          <a href="../#articles">Articles</a>
          <div class="nav-dropdown-menu">
            <a href="../#articles">Fundamental</a>
            <a href="../#articles">Selection Guide</a>
            <a href="../#articles">Technology</a>
            <a href="../#articles">Deployment</a>
            <a href="../#articles">Network Design</a>
          </div>
        </li>
...
<header class="article-header">
  <div class="article-header-inner">
    <span class="article-tag">Selection Guide</span>
    <h1>{title}</h1>
...
<nav class="article-nav">
  <div class="article-nav-inner">
      <a href="Week_14_industrial-network-monitoring-system-memantau-jaringan-ot-tanpa-henti.html" class="prev"><span class="nav-arrow">←</span><span><span class="nav-label">Previous</span><span class="nav-title">Industrial Network Monitoring System</span></span></a>
      <div></div>
  </div>
  <div class="article-nav-back">
    <a href="../#articles">← Kembali ke Semua Artikel</a>
  </div>
</nav>
...
<section class="related-section">
  <div class="related-inner">
    ...
    <div class="related-grid">
      <a href="Week_06_managed-vs-unmanaged-industrial-switch-mana-yang-tepat.html" class="related-card"><span class="tag">Selection Guide</span><h3>Managed vs Unmanaged Industrial Switch: Mana yang Tepat?</h3></a>
      <a href="Week_08_fitur-penting-industrial-ethernet-switch-yang-harus-anda-ketahui.html" class="related-card"><span class="tag">Fundamental</span><h3>11 Fitur Penting Industrial Ethernet Switch</h3></a>
      <a href="Week_01_kenapa-industrial-switch-menggunakan-desain-fanless.html" class="related-card"><span class="tag">Fundamental</span><h3>Kenapa Industrial Switch Menggunakan Desain Fanless</h3></a>
      <a href="Week_09_industrial-switch-vs-commercial-switch-apa-perbedaannya.html" class="related-card"><span class="tag">Technology</span><h3>Industrial Switch vs Commercial Switch</h3></a>
    </div>
  </div>
</section>
...
<footer class="footer">
  <div class="footer-inner">
    ...
    <span>Didistribusikan oleh <a href="../">PT Konexindo Unitama</a></span>
  </div>
</footer>
